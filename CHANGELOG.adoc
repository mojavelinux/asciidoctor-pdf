...
* use scratch document to compute extent for content block in primary document (#2003)
...
* keep block anchor with source/listing/literal block when block is moved to next page (#1897)
...
* use value of untitled-label as fallback value for doctitle in running content (#1772)
* use value of untitled-label as fallback value for Title field in pdfmark (follow-up to #1772)
...
* don't crash if valud of width attribute on image has invalid format (#1970)
...
* use prawn-table release and drop recommendation to use the development version
